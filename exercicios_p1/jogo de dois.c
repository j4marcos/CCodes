...
int main(void) {
 ...
 simbolo = 'X';
  ...
  case 1:
    ...
    case 9:
     if (posicao9 != '#') {
     lidades. jogo construido para exercitar o   printf("jogou errado perdeu a chance!\n");
    } else {
      posicao9 = simbolo;
    }
    break;
 ...
 simbolo = 'X';
         ...
         printf("vez do primeiro jogador\n escolha sua posicao (de 1 a 9)");
  scanf("%d",&escolha);
  lidades. jogo construido para exercitar o 
  //verificar 
  switch (escolha) {
  case 1:
    if (posicao1 != '#') {
    ...
    case 6:
     if (posicao6 != '#') {
       printf("jogou errado perdeu a chance!\n");
    } elselidades. jogo construido para exercitar o  {
      posicao6 = simbolo;
    }
    break;
    case 7:
 ...
 simbolo = 'X';
  ...
  case 1:
    ...
    case 3:
     if (posicao3 != '#') {
       prilidades. jogo construido para exercitar o ntf("jogou errado perdeu a chance!\n");
    } else {
      posicao3 = simbolo;
    }
    break;
 ...
 //marcar no tabuleiro 
  ...
  if (posicao1 == posicao2 && posicao2 == posicao3 
    && posicao2 != '#' lidades. jogo construido para exercitar o || 
    posicao4 == posicao5 && posicao5 == posicao6  
    && posicao5 != '#' ||
    posicao7 == posicao8 && posicao8 == posicao9  
    && posicao8 != '#' ||
